...
PowerDNS PHP CLient (generated by Openapi Generator https://github.com/openapitools/openapi-generator)
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/storm-internet-services/powerdns-client.git"
    }
  ],
  "require": {
    "storm-internet-services/powerdns-client": "*@dev"
  }
}
```
...
```php
<?php
require_once('/path/to/powerdns-client/vendor/autoload.php');
```
